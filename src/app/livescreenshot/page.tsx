    ...
    return (
        <div className='flex flex-col justify-center items-center h-screen '>LiveScreenshot
            ...
            <video autoPlay ref={videoRef} className="bg-slate-50 h-1/2 w1/2 "></video>
                <button className='bg-gradient-to-r from-green-800 to-blue-700 rounded-full px-8 py-3 font-semibold transition-all duration-300 ease-in-out hover:-translate-y-2 hover:bg-gradient-to-r hover:from-blue-600 hover:to-green-700 active:translate-y-0 focus:ring-4 m-3 '
                    onClick={startRec}>start</button>
